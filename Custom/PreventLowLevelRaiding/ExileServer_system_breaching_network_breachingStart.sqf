...
private["_sessionID","_parameters","_constructionObject","_player","_explosiveClassName","_breachingClassname","_territory", "_charge","_Veh","_saveTheBambis","_protectionMessage","_noMoreProtectionNow"];
